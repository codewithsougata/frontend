        ...
        {messages.length === 0 ? (
          <>
            <div className="flex items-center gap-3">
              <Image src={assets.logo_icon} alt="" className="h-10 w-10" />
              <p className="text-2xl font-medium">Hi, I'm DeepVision.</p>
            </div>
          ...
          >
            <p className="fixed top-8 border border-transparent hover:border-gray-500 50 py-1 px-2 rounded-1g font-semibold mb-6">
              {selectedChat.name}
            </p>
